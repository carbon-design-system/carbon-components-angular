...
@Component({
	...
	template: `
		<h2 class="p-demo-heading h1">Drop-down list</h2>
		...
		<h4 class="p-demo-variation h3">Disabled</h4>
		<div style="width: 400px">
			<n-dropdown
		...
		<h3 class="p-demo-section h2">Searchable</h3>
		...
		<h3 class="p-demo-section h2">Hierarchy</h3>
		<h4 class="p-demo-variation h3">Tree</h4>
		<div style="width: 400px">
			<n-dropdown placeholder="Select an option">
				<n-dropdown-tree
					[items]="demoItems3"
		...
		<h4 class="p-demo-variation h3">Sub menu</h4>
		...
		<h3 class="p-demo-section h2"><code>appendToBody</code> enabled</h3>
		...
		<h3 class="p-demo-section h2">ngModel</h3>
		<h4 class="p-demo-variation h3">Single select</h4>
		<div style="width: 400px">
			<n-dropdown
				placeholder="Select an option"
		...
		<h3 class="p-demo-section h2">Events</h3>
		<h4 class="p-demo-variation h3">Multi-select selected</h4>
		<n-dropdown
			placeholder="Select an option"
		...
		<h4 class="p-demo-variation h3">Reactive form</h4>
		<n-dropdown
			placeholder="Select an option"
			[formControl]="test">
		...
		<br>
		<h4 class="p-demo-variation h3">Drop-down filter</h4>
		<div class="dropdown_wrapper">
			<div class="dropdown_menu" style="position: relative; display: block;" role="listbox">
				<n-dropdown-filter [items]="demoItems1"></n-dropdown-filter>
			</div>
		...
		<br>
		<h4 class="p-demo-variation h3">Drop-down multi filter</h4>
		<div class="dropdown_wrapper">
			<div class="dropdown_menu" style="position: relative; display: block;" role="listbox">
		...
		<br>
		<h4 class="p-demo-variation h3">Drop-down tree</h4>
		<div class="dropdown_wrapper">
			<div class="dropdown_menu" style="position: relative; display: block;" role="listbox">
		...
		<br>
		<h4 class="p-demo-variation h3">Drop-down sub menu</h4>
