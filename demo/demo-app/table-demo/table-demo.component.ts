...
@Component({
	...
	<button class="btn--primary" (click)="model.addRow()">Add row</button>
	<button class="btn--primary" (click)="model.addColumn()">Add column</button>
	...
	<button class="btn--primary" *ngFor="let column of model.header" (click)="column.visible = !column.visible">
		Toggle {{column.data}}
	</button><br>

	<button class="btn--primary" *ngFor="let column of model.header; let i = index"
