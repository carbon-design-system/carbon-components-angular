...
@Component({
	...
	<button class="btn--primary" nTooltip="I am a tooltip" trigger="mouseenter" type="warning">Tooltip top</button>
	...
	<button class="btn--primary" nTooltip="I am a tooltip" type="warning">Tooltip top</button>
	...
	<button class="btn--primary" [nTooltip]="customTooltip" type="warning">Tooltip top</button>
