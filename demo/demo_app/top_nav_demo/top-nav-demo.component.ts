	...
	<cdl-top-nav [fixed]="false">
		...
		<ul class="top-nav-links fr" menu>
			...
			<li>
				<a class="top-nav-link-item" href="#">
					<div class="menu-icon">
						<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><path d="M10 2.9c-2.5 0-4.5 2-4.5 4.5S7.5 12 10 12s4.5-2 4.5-4.5-2-4.6-4.5-4.6zm0 7.9c-1.8 0-3.3-1.5-3.3-3.3S8.2 4.1 10 4.1s3.3 1.5 3.3 3.3-1.5 3.4-3.3 3.4z"/><path d="M10 0C4.5 0 0 4.5 0 10s4.5 10 10 10 10-4.5 10-10S15.5 0 10 0zm6 16.4v-1.5c0-1-.9-1.9-2-1.9H6c-1.1 0-2 .9-2 1.9v1.5c-1.7-1.6-2.8-3.9-2.8-6.4 0-4.9 3.9-8.8 8.8-8.8s8.8 3.9 8.8 8.8c0 2.5-1.1 4.8-2.8 6.4z"/></svg>
					</div>
					Sam
					<div class="chevron-down">
						<svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path class="st0" d="M14.6 4L8 10.6 1.4 4l-.8.8L8 12.3l7.4-7.5z"/></svg>
					</div>
				</a>
			</li>
			<li>
...
export class TopNavDemo {
	private topNavTitle = "Product Name";
