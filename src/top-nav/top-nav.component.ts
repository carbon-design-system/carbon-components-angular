...
@Component({
	...
	<nav class="top-nav" [ngStyle]="{'position':displayType}">
		<span class="top-nav-hamburger" *ngIf="hamburger">
			...
			<style>.st0{fill:#959595}</style><path class="st0" d="M1
