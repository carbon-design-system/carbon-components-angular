...
import { FlatpickrOptions } from "../flatpickr/flatpickr-options.interface";
		...
		<div class="bx--form-item">
			<div data-date-picker data-date-picker-type="single" class="bx--date-picker bx--date-picker--single">
				<div class="bx--date-picker-container">
					...
					<label for="date-picker-3" class="bx--label" data-toggle>Date Picker label</label>
