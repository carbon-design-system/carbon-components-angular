...
@Component({
	...
	template: `
		<div class="popover {{popoverConfig.placement}} {{popoverConfig.type}} {{popoverConfig.trigger}}" [class.tooltip]="popoverConfig.isTooltip">
			...
			<div class="popover-content">
				...
				<button *ngIf="popoverConfig.isTooltip && popoverConfig.trigger==='click'" class="close-icon"  (click)="onClose()" aria-label="Close Tooltip">
