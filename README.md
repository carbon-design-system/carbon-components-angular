...
- Include a description of changes
  ...
  - reference the related issue
  	...
  	- "issue #123" just references the issue. Only use this if you definitively need the issue to remain open.
...
- add relevant labels (bug, accesibility, design, discussion, feature, etc)
