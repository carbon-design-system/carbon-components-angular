                        ...
                        <ul class="links collapse" ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            ...
                            <li class="link">
                                <a href="modules/TimePickerModule.html" data-type="entity-link">TimePickerModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-TimePickerModule-e024f2b56b32576f919965415d070cb2"' : 'data-target="#xs-components-links-module-TimePickerModule-e024f2b56b32576f919965415d070cb2"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-TimePickerModule-e024f2b56b32576f919965415d070cb2"' :
                                            'id="xs-components-links-module-TimePickerModule-e024f2b56b32576f919965415d070cb2"' }>
                                            <li class="link">
                                                <a href="components/TimePicker.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">TimePicker</a>
                                            </li>
                                        </ul>
                                    </li>
                            </li>
                            <li class="link">
                                <a href="modules/TimePickerSelectModule.html" data-type="entity-link">TimePickerSelectModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-TimePickerSelectModule-0126f2c49abb0857df24b2c4859c0424"' : 'data-target="#xs-components-links-module-TimePickerSelectModule-0126f2c49abb0857df24b2c4859c0424"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-TimePickerSelectModule-0126f2c49abb0857df24b2c4859c0424"' :
                                            'id="xs-components-links-module-TimePickerSelectModule-0126f2c49abb0857df24b2c4859c0424"' }>
                                            <li class="link">
                                                <a href="components/TimePickerSelect.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">TimePickerSelect</a>
                                            </li>
                                        </ul>
                                    </li>
                            </li>
